...
# Versão: UV-v9.0 - Force PyTorch 2.4.1 após todas instalações
# ============================================================
...
echo "============================================================"
echo "[BOOT] SGLang Server - Ministral 3B (UV Edition v9)"
...
# --- ETAPA 3: VLLM PRIMEIRO (ele instala seu próprio PyTorch) ---
echo "[3/9] Instalando vLLM..."
uv pip install --no-cache "vllm==0.6.3.post1"

# --- ETAPA 4: FORÇAR PYTORCH 2.4.1+cu124 (sobrescreve o do vLLM) ---
echo "[4/9] Forçando PyTorch 2.4.1+cu124..."
...
echo "[5/9] Instalando dependências base..."
uv pip install --no-cache \
    "numpy<2.0.0" \
    "transformers==4.48.3" \
...
import sys
print("\n" + "="*60)
print("VERIFICAÇÃO FINAL - UV Edition v9.0")
print("="*60)
