...
# Versão: UV-v2.0 - Fix: índices customizados com uv
# ============================================================
...
export UV_LINK_MODE=copy  # Evita warnings de hardlink

echo "============================================================"
echo "[BOOT] SGLang Server - Ministral 3B (UV Edition v2)"
...
# --- ETAPA 5: FLASHINFER (uv com extra-index) ---
...
# --- ETAPA 6: SGL-KERNEL (usando pip como fallback) ---
# NOTA: sgl-kernel tem problemas com uv, usando pip direto
echo "[6/10] Instalando sgl-kernel (via pip)..."
...
import sys
print("\n" + "="*60)
print("VERIFICAÇÃO FINAL - UV Edition v2.0")
print("="*60)
