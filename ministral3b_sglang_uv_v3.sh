...
# Versão: UV-v3.0 - Fix: sgl-kernel do índice correto (docs.sglang.ai)
# ============================================================
...
echo "============================================================"
echo "[BOOT] SGLang Server - Ministral 3B (UV Edition v3)"
...
# --- ETAPA 6: SGL-KERNEL (índice correto: docs.sglang.ai) ---
echo "[6/10] Instalando sgl-kernel..."
pip install --no-cache-dir --force-reinstall --no-deps sgl-kernel \
    -i https://docs.sglang.ai/whl/cu124
...
import sys
print("\n" + "="*60)
print("VERIFICAÇÃO FINAL - UV Edition v3.0")
print("="*60)
