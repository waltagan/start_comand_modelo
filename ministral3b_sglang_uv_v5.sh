...
# Versão: UV-v5.0 - Fix: nome correto da wheel para sgl-kernel
# ============================================================
...
echo "============================================================"
echo "[BOOT] SGLang Server - Ministral 3B (UV Edition v5)"
...
# --- ETAPA 6: SGL-KERNEL (download direto com nome correto) ---
echo "[6/10] Instalando sgl-kernel (download direto)..."
cd /tmp
WHEEL_NAME="sgl_kernel-0.3.11+cu124-cp310-abi3-manylinux2014_x86_64.whl"
curl -L -o "$WHEEL_NAME" "https://github.com/sgl-project/whl/releases/download/v0.3.11/sgl_kernel-0.3.11%2Bcu124-cp310-abi3-manylinux2014_x86_64.whl"
pip install --no-cache-dir --force-reinstall "$WHEEL_NAME"
rm "$WHEEL_NAME"
cd /workspace
...
import sys
print("\n" + "="*60)
print("VERIFICAÇÃO FINAL - UV Edition v5.0")
print("="*60)
