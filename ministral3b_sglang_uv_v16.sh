#!/bin/bash
# ============================================================
# SGLang Server - Ministral 3B (UV Edition v16.0)
...
echo "============================================================"
echo "[BOOT] SGLang Server - Ministral 3B (UV Edition v16 - BLACKWELL)"
...
echo "[4/6] Instalando Transformers (versão compatível)..."
...
echo "[4/6] Tentando instalar FlashInfer..."
...
# ou desinstalá-lo
echo "[4/6] Verificando compressed_tensors..."
...
print("============================================================")
print("VERIFICAÇÃO - UV Edition v16.0 (Blackwell/SM120)")
print("============================================================")
