...
# Versão: UV-v6.0 - Fix: pip do venv para sgl-kernel
# ============================================================
...
echo "============================================================"
echo "[BOOT] SGLang Server - Ministral 3B (UV Edition v6)"
...
# Definir variável para pip do venv
...
# --- ETAPA 6: SGL-KERNEL (usando pip do venv explicitamente) ---
...
$VENV_PIP install --no-cache-dir --force-reinstall "/tmp/$WHEEL_NAME"
rm "/tmp/$WHEEL_NAME"
...
import sys
print("\n" + "="*60)
print("VERIFICAÇÃO FINAL - UV Edition v6.0")
print("="*60)
