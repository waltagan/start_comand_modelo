...
# Versão: UV-v4.0 - Fix: sgl-kernel do PyPI com --no-binary
# ============================================================
...
echo "============================================================"
echo "[BOOT] SGLang Server - Ministral 3B (UV Edition v4)"
...
# --- ETAPA 6: SGL-KERNEL (download direto da wheel) ---
echo "[6/10] Instalando sgl-kernel (download direto)..."
# Devido ao bug de versão inconsistente, baixamos a wheel diretamente
WHEEL_URL="https://github.com/sgl-project/whl/releases/download/v0.3.11/sgl_kernel-0.3.11%2Bcu124-cp310-abi3-manylinux2014_x86_64.whl"
wget -q -O /tmp/sgl_kernel.whl "$WHEEL_URL"
pip install --no-cache-dir --force-reinstall /tmp/sgl_kernel.whl
rm /tmp/sgl_kernel.whl
...
import sys
print("\n" + "="*60)
print("VERIFICAÇÃO FINAL - UV Edition v4.0")
print("="*60)
